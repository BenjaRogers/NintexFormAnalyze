...
class Console:
    ...
    def main_loop(self):
        ...
        while inp != "0":
            ...
            if searched_control:
                ...
                print(self.build_control_tree_recursive(searched_control, control_id_list))
    ...
    def build_control_tree_recursive(self, control_object: Control, control_id_list: list) -> Tree:
        tree = Tree()
